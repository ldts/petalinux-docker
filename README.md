...
`docker run -ti --rm -e DISPLAY=$DISPLAY --net="host" -v /tmp/.X11-unix:/tmp/.X11-unix -v $HOME/.Xauthority:/home/vivado/.Xauthority -v /home/jramirez/Foundries/projects/nixu/petalinux/project:/home/vivado/project  petalinux:2020.2 /bin/bash`
